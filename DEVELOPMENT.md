...
```bash
git remote add encore encore://twitter-video-sharing-app-2gqi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/twitter-video-sharing-app-2gqi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/twitter-video-sharing-app-2gqi/settings/integrations/github)
